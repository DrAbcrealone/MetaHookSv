...
extern void* (*curl_easy_init)(void) = nullptr;
extern CURLcode(*curl_easy_setopt)(void* curl, CURLoption option, ...) = nullptr;
extern CURLcode(*curl_easy_getinfo)(void* curl, CURLINFO info, ...) = nullptr;
extern CURLcode(*curl_easy_perform)(void* curl) = nullptr;
extern void (*curl_easy_cleanup)(void* curl) = nullptr;
extern struct curl_slist* (*curl_slist_append)(struct curl_slist*, const char*) = nullptr;
extern void (*curl_slist_free_all)(struct curl_slist* list) = nullptr;
